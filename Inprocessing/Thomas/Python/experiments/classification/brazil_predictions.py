...
if __name__ == '__main__':
	...
	dataset = brazil.load(use_pct=args.data_pct, r_train=args.r_train_v_test, r_candidate=args.r_cand_v_safe, include_intercept=True, gpa_cutoff=args.gpa_cutoff)
	...
	fname = 'results/brazil_predictions/%s.npz' % args.definition.lower()
	os.makedirs('results/brazil_predictions/', exist_ok=True)
