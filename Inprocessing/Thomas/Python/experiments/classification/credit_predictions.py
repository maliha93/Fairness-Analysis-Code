...
from datasets  import credit as credit
...
if __name__ == '__main__':
	...
	dataset = credit.load(use_pct=args.data_pct, r_train=args.r_train_v_test, r_candidate=args.r_cand_v_safe, include_intercept=True)
	...
	fname = 'results/credit_predictions/%s.npz' % args.definition.lower()
	os.makedirs('results/credit_predictions/', exist_ok=True)
	np.savez(fname, **output)
	print('   Done. Results saved to \'%s\'.' % fname)
