...
class Dataset(object):
	...
	def resample(self, probf=None):
		...
		I = rand.choice(n, n, replace=True, p=P)
		out =  Dataset(self._X[I], self._R[I], self._T[I], self._n_candidate, self._n_safety, self._n_test, seed=self._seed, include_T=False, include_intercept=False, standardize=False)
		out._include_intercept = self._include_intercept
		out._include_T = self._include_T
		out._standardize = self._standardize
		return out
